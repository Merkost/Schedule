...
private val DarkColorScheme = darkColorScheme(
    ...
    secondary = BrandSecondaryForDark,
    onSecondary = BrandOnSecondaryForDark,
    secondaryContainer = BrandSecondaryContainerForDark,
    onSecondaryContainer = BrandOnSecondaryContainerForDark,
    tertiary = BrandTertiaryLight,
    onTertiary = BrandOnTertiaryForDark,
    tertiaryContainer = BrandTertiaryContainerForDark,
