...
object IosGoogleAuthBridge {
    var signInImpl: ((onResult: (idToken: String?, accessToken: String?, error: String?) -> Unit) -> Unit)? = null
    var signOutImpl: (() -> Unit)? = null
}

fun installSignInBridge(
    signIn: (onResult: (idToken: String?, accessToken: String?, error: String?) -> Unit) -> Unit,
    signOut: () -> Unit,
) {
